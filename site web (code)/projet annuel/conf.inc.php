...
define('DB_NAME', 'esgi1i2');



$listOfCountry = ["fr"=> "France","ge"=> "Bosh","pl"=> "pologne","it"=> "Italie","ru"=> "Russie","pl"=> "pologne","tr"=> "Trump"];


$listOfGender = ["m"=> "Mr","w"=> "Mme","g"=> "Mlle","o"=> "Autre",];
...
8 =>"tu as cru m'avoir avec le gendre ? ",
9 =>"tu as cru m'avoir avec le pays ?",
