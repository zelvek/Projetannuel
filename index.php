       ...
       <div class="row">
         <div class="col-lg-12">
           <div class="row">
             ...
             <a href="inscription.php" class="myButton col-lg-2 col-md-2 col-lg-push-2 left"  target=_blank>inscription</a>



             <a href="connexion.php" class="myButton col-lg-2 col-md-2 col-lg-pull-2 test2"  target=_blank>connexion</a>
